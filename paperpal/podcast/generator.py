    ...
    def _get_podcast_description(self, text: str) -> str:
        ...
        try:
            ...
            if self.text_inference.provider == "ollama":
                ...
                return raw_response.get("description", "A podcast episode generated by PaperPal.")
                ...
                try:
                    ...
                    return data.get("description", "A podcast episode generated by PaperPal.")
                except Exception as e:
                    print(f"Error parsing description JSON: {str(e)}")
                    return "A podcast episode generated by PaperPal."
        except Exception as e:
            print(f"Error generating podcast description: {str(e)}")
            return "A podcast episode generated by PaperPal."
    ...
    def generate_podcast(
        ...
        try:
            ...
            if isinstance(pdf_paths, str):
                pdf_paths = [pdf_paths]
            if isinstance(paperpal_sections, str):
                paperpal_sections = [paperpal_sections]
            ...
            dialogue = self._get_dialogue(
                "\n".join(texts),
                "\n".join(paperpal_sections) if paperpal_sections else ""
            )
