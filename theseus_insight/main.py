...
@app.get("/api/task-history", response_model=List[TaskHistoryEntry])
...
@app.websocket("/ws/database-export/{task_id}")
...
@app.post("/api/settings/database/export-task")
...
@app.get("/api/settings/database/export-task/{task_id}/download")
